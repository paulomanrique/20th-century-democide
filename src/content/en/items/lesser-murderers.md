---
title: "lesser"
itemId: lesser-murderers
collection: statistics-of-democide
originalUrl: "https://www.hawaii.edu/powerkills/SOD.CHAP15.HTM"
sourceType: original
sourceUsed: "https://www.hawaii.edu/powerkills/SOD.CHAP15.HTM"
captureDate: "2026-03-31T21:23:39.391Z"
provenance:
  sourceId: hawaii-powerkills
  rawPath: data/raw/hawaii-edu/lesser-murderers.html
  hash: b8da265084a2003c7b100995f76f3e20b0ef0fc18bb2c585ad46820a13e830e0
originalFormat: html
assets: []
editorialNotes:
...
In Tables 15.1A to 15.1E I list estimates, sources, and calculations for all governments of sovereign states and quasi-states that have probably murdered no more than 99,999 people. Quasi-states are groups within a formally sovereign state that through force are _de facto_ sovereign over a defined and relatively stable territory (which might be evidenced by the collection of taxes or conscription). The tables are divided as follows.

*   Table [15.1A](SOD.TAB15.1A.GIF), lines 1-578, Afghanistan Rebels to Chile
*   Table [15.1B](SOD.TAB15.1B.GIF), lines 579-1160, Central African Empire to Ethiopia (Eritrea)
*   Table [15.1C](SOD.TAB15.1C.GIF), lines 1063-1753, France (Vichy) to India (democracy)
*   Table [15.1D](SOD.TAB15.1D.GIF), lines 1754-2255, Iran to Laos
*   Table [15.1E](SOD.TAB15.1E.GIF), lines 2258-2800, Lebanon (groups) to Poland (authoritarian)
*   Table [15.1F](SOD.TAB15.1F.GIF), lines 2801-end, Rumania to Zimbabwe
...
To locate a particular state or group, go to overview [Table 16A.1](SOD.TAB16A.1.GIF), which lists all states and groups in alphabetical order, includes their democide, and gives the table and line number of their location in [_Statisticis of Democide_](NOTE5.HTM). Tables can then by located by hypertext in the [tables](NOTE5.HTM) part of the contents to _Statistics of Democide_. 

* * *

### NOTES

> \* From the pre-publisher edited manuscript of Chapter 15 in R.J. Rummel, _Statistics of Democide_, 1997. For full reference to _Statistics of Democide_, the list of its contents, figures, and tables, and the text of its preface, click [book](NOTE5.HTM).
