...
[Contents](NOTE5.HTM) | [Figures](NOTE5.HTM#FIG) | [Tables](NOTE5.HTM#TAB) | [Preface](NOTE5.HTM#PREFACE)

[Chapter 1:](SOD.CHAP1.HTM) Summary and Conclusions \[Why Democide?...\]  
[Chapter 2:](SOD.CHAP2.HTM) Pre-Twentieth Century Democide  
[Chapter 3](SOD.CHAP3.HTM) Japan's Savage Military  
[Chapter 4:](SOD.CHAP4.HTM) The Khmer Rouge Hell State  
[Chapter 5:](SOD.CHAP5.HTM) Turkey's Ethnic Purges  
[Chapter 6:](SOD.CHAP6.HTM) The Vietnamese War State  
[Chapter 7:](SOD.CHAP7.HTM) Poland's Ethnic Cleansing  
[Chapter 8:](SOD.CHAP8.HTM) The Pakistani Cutthroat State  
[Chapter 9:](SOD.CHAP9.HTM) Tito's Slaughterhouse  
[Chapter 10:](SOD.CHAP10.HTM) Orwellian North Korea  
[Chapter 11:](SOD.CHAP11.HTM) Barbarous Mexico  
[Chapter 12:](SOD.CHAP12.HTM) Feudal Russia  
[Chapter 13:](SOD.CHAP13.HTM) Death American by bombing  
[Chapter 14:](SOD.CHAP14.HTM) The Gang of Centi-Kilo Murderers  
[Chapter 15:](SOD.CHAP15.HTM) The Lesser Murderers  
[Chapter 17:](SOD.CHAP17.HTM) Democracy, Power, and Democide  
[Chapter 18:](SOD.CHAP18.HTM) Social Diversity, Power, and Democide  
[Chapter 19:](SOD.CHAP19.HTM) Culture and Democide  
[Chapter 20:](SOD.CHAP20.HTM) The Context of Democide Socio-Economic and Geographic  
[Chapter 21:](SOD.CHAP21.HTM) War, Rebellion, and Democide  
[Chapter 22:](SOD.CHAP22.HTM) The Social Field and Democide  
[Chapter 23:](SOD.CHAP23.HTM) Democide Through the Years  
[References](SOD.REF.HTM)
...
*   [What is democide?](DBG.CHAP2.HTM)  
...
> \* From the pre-publisher edited manuscript of Chapter 16 in R.J. Rummel, _Statistics of Democide_, 1997. For full reference to _Statistics of Democide_, the list of its contents, figures, and tables, and the text of its preface, click [book](NOTE5.HTM).
> 
> 1. The social field theory that is the framework for this analysis assumes a Euclidean space, linear in the mathematical functions within this space, although the terms within the functions may have non-linear relationships. The best method for delineating these functions and the dimensions of this space is component (factor) analysis. See ["Understanding Factor Analysis."](UFA.HTM)
> 
> 2. Thurstone (1947, pp. 140-46). The methodological difference between component and factor analysis is in analyzing all the variance among a sample of variables or just the variance they presumably have in common. Factor analysts are typically concerned only with common variance, arguing that they are seeking or testing for some underlying common factors. Statistically, however, the difference is often obscured, because factor analysts will estimate the common variance by the correlation of a variable with itself (= 1.00), and thus actually be doing component analysis. For these distinctions and a full discussion of relevant aspects of component and factor analysis, see Rummel (1970). For a summary, see ["Understanding Factor Analysis"](UFA.HTM)
> 
> 3. The most extensive development and application has been to domestic and foreign conflict. See particularly Rummel ([_Understanding Conflict and War_](UCW.HTM), Vol. 2-4). I have used Catastrophe Theory to mathematically model the conflict helix (["A Catastrophe Theory Model Of The Conflict Helix, With Tests"](CAT.ART.HTM)), and have presented the related psychological, interpersonal, social, and international principles in a non-technical introduction ([_Conflict Helix: Principles and Practices...._](NOTE9.HTM)).
> 
...
> 
> 5. Rummel ([1990](NOTE4.HTM), [1991](NOTE2.HTM), [1992](NOTE3.HTM)).
> 
> 6. I present and discuss the nature and an extended definition of democide in Rummel (1994, [Chapter 2](DBG.CHAP2.HTM)). Politicide is an important conceptual type of democide (murder by a regime for political reasons), but I could not empirically discriminate it from the types shown in the table.
> 
